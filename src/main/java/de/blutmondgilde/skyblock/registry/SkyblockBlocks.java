...
public class SkyblockBlocks extends AbstractSkyblockRegistry {
    ...
    public final RegistryObject<CompressedBlock> compressedLapisLazuliBlock = registry.register("compressed_lapis_lazuli_block", () -> new CompressedBlock(Blocks.LAPIS_BLOCK));
