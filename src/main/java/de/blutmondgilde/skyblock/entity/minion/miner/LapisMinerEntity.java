...
public class LapisMinerEntity extends MinerEntity {
    ...
    public Map<Item, Integer> getItemsForLevelUp() {
        ...
        return switch (getMinionLevel()) {
            case 1 -> Map.of(Items.LAPIS_LAZULI, 160);
            case 2 -> Map.of(Items.LAPIS_LAZULI, 320);
            case 3 -> Map.of(Items.LAPIS_LAZULI, 512);
            case 4 -> Map.of(SkyblockRegistries.items.compressedLapisLazuli.get(), 8);
            case 5 -> Map.of(SkyblockRegistries.items.compressedLapisLazuli.get(), 24);
            case 6 -> Map.of(SkyblockRegistries.items.compressedLapisLazuli.get(), 64);
    ...
    protected MutableComponent getResultName() {
        return Items.LAPIS_LAZULI.getName(new ItemStack(Items.LAPIS_LAZULI)).copy();
    }
}
